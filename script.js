class Person { // Holds name and balance for each person
  ...
  owe(personB) { // Returns the amount this person owes another
    ...
    return this.name + " owes " + personB.name + " " + String(temp) + "<br>";
  }
}
...
function readForm() { // Reads the data input
  ...
  var person1 = new Person(form1.elements[0].value, form1.elements[1].value);
  formResult.push(person1);

  var form2 = document.getElementById("form2");
  var person2 = new Person(form2.elements[0].value, form2.elements[1].value);
  formResult.push(person2);

  if (people > 2) {
    var form3 = document.getElementById("form3");
    var person3 = new Person(form3.elements[0].value, form3.elements[1].value);
    formResult.push(person3);
  }

  if (people > 3) {
    var form4 = document.getElementById("form4");
    var person4 = new Person(form4.elements[0].value, form4.elements[1].value);
    formResult.push(person4);
  }

  if (people > 4) {
    var form5 = document.getElementById("form5");
    var person5 = new Person(form5.elements[0].value, form5.elements[1].value);
    formResult.push(person5);
  }

  if (people > 5) {
    var form6 = document.getElementById("form6");
    var person6 = new Person(form6.elements[0].value, form6.elements[1].value);
    formResult.push(person6);
  }

  if (people > 6) {
    var form7 = document.getElementById("form7");
    var person7 = new Person(form7.elements[0].value, form7.elements[1].value);
    formResult.push(person7);
  }

  if (people > 7) {
    var form8 = document.getElementById("form8");
    var person8 = new Person(form8.elements[0].value, form8.elements[1].value);
    formResult.push(person8);
  }

  if (people > 8) {
    var form9 = document.getElementById("form9");
    var person9 = new Person(form9.elements[0].value, form9.elements[1].value);
    formResult.push(person9);
  }

  if (people > 9) {
    var form10 = document.getElementById("form10");
    var person10 = new Person(form10.elements[0].value, form10.elements[1].value);
